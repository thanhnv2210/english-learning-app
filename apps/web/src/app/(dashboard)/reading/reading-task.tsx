      ...
      nodes.push(
        seg.highlightId ? (
          <mark
            ...
            className="bg-yellow-200 text-foreground rounded-sm px-0.5 cursor-pointer hover:bg-red-100 transition-colors"
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">Practice with a previously saved passage in this domain.</p>
              </button>
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">Create a fresh passage with AI and save it to the library.</p>
              </button>
            </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {totalHighlights > 0 && (
            <button
              ...
              className="rounded-lg border border-border bg-card px-2.5 py-1.5 text-xs text-muted-foreground hover:border-red-300 hover:text-red-500 transition-colors"
      ...
      <div className="flex gap-4 flex-1 min-h-0">
        ...
        <div className="flex-[55] flex flex-col min-w-0 rounded-xl border border-border bg-card overflow-hidden">
          ...
          <div
            ...
            className={`flex-1 overflow-y-auto px-6 py-5 text-sm text-foreground leading-7 select-text ${highlightMode ? 'cursor-text' : 'cursor-default'}`}
          >
            <PassageParagraphs
              ...
              <>
                ...
                <div className="flex flex-col gap-3">
                  <div className="rounded-lg bg-muted border border-border p-3">
                    <p className="text-sm font-semibold text-foreground">Score: {scoreResult.correct}/{scoreResult.total}</p>
  ...
  return (
    <div className={`rounded-lg border p-3 flex flex-col gap-2 text-sm transition-colors ${
      ...
      <p
        ...
        className={`text-foreground leading-snug select-text ${highlightMode ? 'cursor-text' : ''}`}
      >
  ...
  return (
    <div className={`rounded-lg border p-3 flex flex-col gap-2 text-sm transition-colors ${
      ...
      <input
        ...
        className="w-full rounded-md border border-border px-3 py-1.5 text-sm outline-none focus:border-blue-500 disabled:bg-card disabled:text-muted-foreground select-none"
      />
      {correctAnswer && result === false && (
