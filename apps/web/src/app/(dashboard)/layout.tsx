  ...
  return (
    <>
      ...
      <MobileHeader
        ...
        isNewUser={!user.returningUser}
        unlockedPages={user.unlockedPages ?? []}
      />
      ...
      <div className="flex h-screen overflow-hidden bg-background">
        ...
        <div className="flex flex-1 flex-col overflow-hidden min-w-0">
          ...
          <main className="flex-1 overflow-y-auto overflow-x-hidden pt-12 sm:pt-0 p-3 sm:p-5 md:p-6 lg:p-8 2xl:p-12">
            <BackButton />
            {children}
          </main>
        </div>
