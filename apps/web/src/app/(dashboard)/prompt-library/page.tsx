...
export default async function PromptLibraryPage() {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-1">AI Prompt Library</h1>
      <p className="text-sm text-gray-500 mb-8">
        Ready-to-use practice prompts for ChatGPT, Gemini, or Claude.
        Replace <span className="font-mono text-xs bg-gray-100 px-1 py-0.5 rounded">[BRACKETED]</span> placeholders before copying.
      </p>
