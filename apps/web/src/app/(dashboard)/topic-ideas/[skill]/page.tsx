      ...
      <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2">
        {TOPICS.map((topic) => (
          <Link
            ...
            className="flex flex-col gap-2 rounded-xl border border-border bg-card p-5 transition-colors hover:border-blue-300 dark:hover:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-900/20"
          >
