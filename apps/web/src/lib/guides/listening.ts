...
export const LISTENING_GUIDES: QuestionTypeGuide[] = [
  {
    ...
    steps: [
      'Before the recording starts, read all the gaps on screen carefully. On your scratch paper, jot the one or two words immediately before and after each blank — these are your listening triggers.',
      'Predict the type of word needed for each gap — noun, number, adjective, verb, etc. Note the predicted type next to each gap on your scratch paper. This narrows your listening focus.',
  ...
  },
  {
    ...
    steps: [
      ...
      'On your scratch paper, note one key content word from each sentence — this is the keyword you will listen for in the recording.',
  ...
  },
  {
    ...
    steps: [
      'Read the question stem on screen carefully. On your scratch paper, note the key topic in one or two words — this tells you what to listen for.',
      'Read all three options before the recording starts. Note the key difference between them on your scratch paper.',
      'As you listen, use your scratch paper to cross off options that are explicitly contradicted or rejected by the speaker.',
  ...
  },
  {
    ...
    steps: [
      ...
      'For each item, jot one key word on your scratch paper that will help you locate the relevant section in the recording.',
  ...
  },
  {
    ...
    steps: [
      'Study the visual on screen carefully before the recording starts. Identify reference points that are already labelled (e.g. "Entrance", "North"). On your scratch paper, sketch a quick rough copy to orientate yourself — this lets you annotate without touching the screen.',
  ...
  },
  {
    ...
    steps: [
      ...
      'On your scratch paper, note the key content word from each question so you know when the relevant section of the recording begins.',
